...
app.get('/chartmodel', function (req, res) {
    ...
    chartModelProducer.getChartModel(startTimeParam, endTimeParam).then(function (chartModel) {
        ...
        var propertiesObject = {startTime: startTimeParam, endTime: endTimeParam};
        url = 'http://nodejs-mongo-persistent-btcpriceandsearch.1d35.starter-us-east-1.openshiftapps.com/chartmodel';
